...
from term.permissions import IsITManagerOrEducationalAssistantWithSameFaculty, IsSameEducationalAssistant, IsSameStudent, IsSameProfessor
...
from account.models import EducationalAssistant, Professor, Student
